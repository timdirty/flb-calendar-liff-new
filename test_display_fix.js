        ...
        if (hasLoadingIssue) {
            ...
            const elementsExist = await page.evaluate(() => {
                return {
                    ...
                    teacherElement: !!document.getElementById('currentTeacher'),
                    courseElement: !!document.getElementById('currentCourse')
                };
            });
            console.log('🔍 元素存在性:', elementsExist);
        } else {
...
// 運行測試
testDisplayFix().catch(console.error);
