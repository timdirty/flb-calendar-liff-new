...
async function testSimplifiedCourseInfo() {
    console.log('🚀 開始測試簡化後的課程資訊顯示...');
    ...
    try {
        ...
        // 最終檢查
        const finalHasLoadingIssue = finalCourseInfo.time === '載入中...' || finalCourseInfo.date === '載入中...';
        
        if (finalHasLoadingIssue) {
...
// 運行測試
testSimplifiedCourseInfo().catch(console.error);
