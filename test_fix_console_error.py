    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if frontend_response.status_code == 200:
                ...
                # 檢查 bindQuickFilterButtons 調用已移除
                if 'bindQuickFilterButtons()' not in frontend_response.text:
                    print("✅ bindQuickFilterButtons 調用已移除")
                else:
                    print("❌ bindQuickFilterButtons 調用仍然存在")
